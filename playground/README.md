...
- Log out and back in to see the **email 2FA challenge**. The Playground blueprint
  includes a demo-only helper that prints the current code directly on the 2FA
  challenge screen, because Playground has no real mailbox for the pre-created
  user. You can also read the email at **Tools → WP Mail Logging**.
